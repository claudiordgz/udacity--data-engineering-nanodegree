...
copy_trips_task = S3ToRedshiftOperator(
    ...
    s3_key="data-pipelines/divvy/partitioned/2018/{execution_date.month}/divvy_trips.csv"
)
...
create_trips_table >> copy_trips_task >> check_stations
create_stations_table >> copy_stations_task >> check_trips
